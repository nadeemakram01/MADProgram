...
public class TipFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPager viewPager = (ViewPager) view.findViewById(R.id.tipcontent);
    ...
    /**
     * Step 2 - Create a FragmentPagerAdapter
     *
     */
     public class CustomAdapter extends FragmentPagerAdapter{
        ...
        public Fragment getItem(int position){
            switch(position){
                case 0: return FactFragment.newInstance("When naming a variable you should always use camel case");
                case 1: return FactFragment.newInstance("Comment often and be as detailed as possible");
                case 2: return FactFragment.newInstance("Name variables and classes with descriptive names");
                case 3: return FactFragment.newInstance("Don\'t be afraid to make mistakes");
                case 4: return FactFragment.newInstance("Never forget a semicolon");
                default: return FactFragment.newInstance("Shorter code does not mean better code");
            }
        }
